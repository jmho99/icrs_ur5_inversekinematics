...
#include "calc_interfaces/srv/six_theta.hpp"
...
void set(const std::shared_ptr<calc_interfaces::srv::SixTheta::Request> request,
	std::shared_ptr<calc_interfaces::srv::SixTheta::Response> response)
{
...
int main(int argc, char **argv)
{
	...
	rclcpp::Service<calc_interfaces::srv::SixTheta>::SharedPtr service =
