...
class target_act_client : public rclcpp::Node
{
public:
    using Interface = interfaces_ur5ik::action::CalcTheta;
    using GoalHandleInterface = rclcpp_action::ClientGoalHandle<Interface>;

    explicit target_act_client(const rclcpp::NodeOptions & options = rclcpp::NodeOptions())
    : Node("target_act_client", options)
    {
        this->m_action_client = rclcpp_action::create_client<Interface>(
            ...
            this->m_timer = this->create_wall_timer(
                ...
                std::bind(&target_act_client::send_goal, this));
    }
    ...
    void send_goal()
    {
        ...
        send_goal_options.goal_response_callback =
            std::bind(&target_act_client::goal_response_callback, this, _1);
        send_goal_options.feedback_callback =
            std::bind(&target_act_client::feedback_callback, this, _1, _2);
        send_goal_options.result_callback =
            std::bind(&target_act_client::result_callback, this, _1);
...
int main(int argc, char **argv)
{
    ...
    rclcpp::spin(std::make_shared<target_act_client>());
	rclcpp::shutdown();
}