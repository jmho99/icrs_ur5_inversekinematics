...
#include "interfaces_ur5ik/action/calc_theta.hpp"
#include "rclcpp/rclcpp.hpp"
#include "rclcpp_action/rclcpp_action.hpp"

//namespace calc_ur5ik_action_cpp

class calc_act_server : public rclcpp::Node
{
public:
    using Interface = interfaces_ur5ik::action::CalcTheta;
    using GoalHandleInterface = rclcpp_action::ServerGoalHandle<Interface>;

    explicit calc_act_server(const rclcpp::NodeOptions & options = rclcpp::NodeOptions())
    : Node("calc_act_server", options)
    {
        ...
        this->m_action_server = rclcpp_action::create_server<Interface>(
            this,
            "action_ik",
            std::bind(&calc_act_server::handle_goal, this, _1, _2),
            std::bind(&calc_act_server::handle_cancel, this, _1),
            std::bind(&calc_act_server::handle_accepted, this, _1)
        );
    }
private:
    ...
    void handle_accepted(const std::shared_ptr<GoalHandleInterface> goal_handle)
    {
        ...
        std::thread{std::bind(&calc_act_server::execute, this, _1), goal_handle}.detach();
    }
...
int main(int argc, char **argv)
{
	...
	rclcpp::spin(std::make_shared<calc_act_server>());
	rclcpp::shutdown();
}
